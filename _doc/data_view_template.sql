/*
 ...
 Source Schema         : data_view_template

 Target Server Type    : MySQL
 Target Server Version : 50725
 File Encoding         : 65001

 Date: 13/05/2019 15:44:16
*/
...
CREATE TABLE `bpv_line_stacking_area_1`  (
  ...
  `x` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `y` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `gauge`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `value` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of gauge
-- ----------------------------
INSERT INTO `gauge` VALUES (1, '完成率', '27.4');
...
CREATE TABLE `group`  (
  ...
  `group` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'aa',
  `base` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `histogram_complex_bar`  (
  ...
  `xaxis` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
...
CREATE TABLE `histogram_gradient`  (
  `id` int(255) NOT NULL,
  `x` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `histogram_stacking`  (
  ...
  `x` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `stack` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `map_china_tmp`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `legend` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `radar`  (
  `legend` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `value` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `max` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
...
CREATE TABLE `relation_five`  (
  ...
  `group` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `rotation_list` VALUES ('1', '赵一', '20', 'text');
INSERT INTO `rotation_list` VALUES ('2', '钱二', '21', 'text');
INSERT INTO `rotation_list` VALUES ('3', '孙三', '22', 'text');
INSERT INTO `rotation_list` VALUES ('4', '李四', 'http://cdnimg103.lizhi.fm/album_cover/2015/06/18/20837070441448732_320x320.jpg', 'img');
INSERT INTO `rotation_list` VALUES ('5', '周五', '24', 'text');
...
CREATE TABLE `user`  (
  `id` int(100) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'mmmm',
  `region` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'china',
  `flow` int(255) DEFAULT 0,
  `behavior` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'fight',
  `label` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'jquery',
  `attributes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',

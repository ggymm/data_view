...
type RelationOneGetData struct {
}

func New() *RelationOneGetData {
	return &RelationOneGetData{}
}

//GetDataFromDB
func (relationOneGetData *RelationOneGetData) GetDataFromDB(db *sql.DB, chartDataParams *utils.ChartDataParams) (result string, err error) {
...
func (relationOneGetData *RelationOneGetData) GetDataFromCsv(chartDataParams *utils.ChartDataParams) (result string, err error) {
	return "", nil
}
